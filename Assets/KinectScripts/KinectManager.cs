							...
							gestureData.progress >= 0.5f)
						{
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								if(HandCursor1 != null)
								{
									...
									if(HandCursor1.GetComponent<RawImage>() == null) //weg 
									{
								...
								if(ControlMouseCursor)
								{
									Vector3 vCursorPos = HandCursor1.GetComponent<RawImage>() != null ? HandCursor1.transform.position : //weg
							...
							gestureData.progress >= 0.5f)
						{
							if(GetGestureProgress(gestureData.userId, KinectGestures.Gestures.Click) < 0.3f)
							{
								if(HandCursor2 != null)
								{
									...
									if(HandCursor2.GetComponent<RawImage>() == null) //weg
									{
								...
								if(ControlMouseCursor)
								{
									Vector3 vCursorPos = HandCursor2.GetComponent<RawImage>() != null ? HandCursor2.transform.position : //weg
...
//					}
	...
	void RemoveUser(uint UserId)
	{
		...
		if(CalibrationText != null)
		{
			CalibrationText.text = "WAITING FOR USERS"; //weg
		}
	}
